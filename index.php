          ...
          <div class="container">
            ...
            <div class="row">
              <div class="col-md-8 col-md-offset-2 wp1">
				...
				<!-- about / welcome text -->
                <p>
                  I'm a passionate in programming networking and cyber security .Interested cyber security ,development and networking
                  </p>
                  <br>
                  Languages i know inlude:<br>
                  Programming Languages  :Java,C# and intermidiate in Python.<br>
                  Scripting Languages :Php,js.<br>
...
<!-- ==========================
        ...
        <!-- Headline -->
          ...
          <!-- Service Box 1 -->
                  <div class="col-md-4 wp2 item">
                    ...
                    <h2>Web Development</h2><!-- Title -->
                    <p>
                      I  am a full stack developer in Mysql,Html and Java/php/C#/Javascript as server side language.
          ...
          <!-- Service Box 2 -->
                  <div class="col-md-4 wp2 item delay-05s">
                    ...
                    <p>I have good choice of layout and colors to go altogehter with the website and I have made clients happy</p><!-- Description -->
                  </div>
          <!-- Service Box 3 -->
                  <div class="col-md-4 wp2 item delay-1s">
                    <div class="icon">
                      <i class="fa fa-android"></i><!-- Icon -->
                    </div>
                    <h2>Android  Development</h2><!-- Title -->
                    <p>I develop android app in Java and still learning .</p><!-- Description -->
                  </div>
          </div>
		...
		<div class="container-fluid">
			...
			<div class="row color-bg">
				...
				<div class="col-md-6 about-text">
					<h6>High quality Website</h6><!-- headline-->
					<p>I develop website with high quality capable of being flexible
			...
			<div class="row">
				<div class="col-md-6 about-text">
					<h6>Professional web Desing</h6><!-- Headline -->
					<p>I have applied my art to design eye catchin web layout
            	<a href="index.html#team" class="weight-outline-btn">Read more</a>	<!-- read more button  -->				
				</div>
				<div class="col-md-6 nopadding features-intro-img">
			...
			<div class="row color-bg">
				...
				<div class="col-md-6 about-text">
					<h6>Android Development</h6><!-- Headline-->
					<p>Not that pro skilled in the android but i hae delivered amazing layout desgins and software for the clients .
            	<a href="index.html#team" class="weight-outline-btn">Read more</a><!-- read more button  -->					
				</div>
			</div>
		</div>
    ...
    =========================== -->
        ...
        <div class="container">
          ...
          <div class="col-md-3 col-sm-6">
              <div class="overlay-effect effects clearfix">
                  <div class="img">
                      <a href="img/portfolio/twenty.png" data-lightbox="roadtrip" title="Website - Odds website"><img class="grayscale" src="img/portfolio/twenty.png" alt="Portfolio Item"></a>
                  </div>
              </div>
          </div>
  	    <!-- PORTFOLIO ITEM END -->
          ...
          <div class="col-md-3 col-sm-6">
              <div class="overlay-effect effects clearfix">
                  <div class="img">
                      <a href="img/portfolio/app4.png" data-lightbox="roadtrip" title="Android APP - https://play.google.com/store/apps/details?id=com.surii.a20plus&hl=en_US&gl=US"><img class="grayscale" src="img/portfolio/app4.png" alt="Portfolio Item"></a>
                  </div>
              </div>
          </div>
  	    <!-- PORTFOLIO ITEM END -->
        ...
        <div class="col-md-3 col-sm-6">
          <div class="overlay-effect effects clearfix">
              <div class="img">
                  <a href="img/portfolio/app3.png" data-lightbox="roadtrip" title="Android APP - https://play.google.com/store/apps/details?id=com.surii.a20plus&hl=en_US&gl=US"><img class="grayscale" src="img/portfolio/app3.png" alt="Portfolio Item"></a>
              </div>
          </div>
      </div>
    <!-- PORTFOLIO ITEM END -->
		...
		<div class="spacer-cta text-center">
          <div class="container">
            <div class="row">
              <div class="col-md-12">
                <a href="index.html#contact" class="outline-btn">hire Ian Muthuri</a>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="row contact-details">
              ...
              <div class="col-md-4">
                <div class="dark-box box-hover">
                  ...
                  <p><a href="index.html#">devianinfotech@gmail.com</a></p>
                </div>
              </div>
              <div class="col-md-4">
                <div class="dark-box box-hover">
                  <h2><i >0</i><span>Adress</span></h2>
                  <p><a href="index.html#">Onganta Rongai,53067-00200</a></p>
                </div>
              </div>
            </div>
			<!--  -->
            ...
            <div class="row">
              <div class="col-md-12">
                <ul class="social-buttons">
                  <li><a href="https://www.twitter.com/ian_surii" class="social-btn"><i class="fa fa-twitter"></i></a></li><!-- dribble -->
                  <li><a href="https://www.github.com/IanSurii" class="social-btn"><i class="fa fa-github"></i></a></li><!-- twitter -->
                  <li><a href="https://www.facebook.com/iansurii" class="social-btn"><i class="fa fa-facebook"></i></a></li><!-- facebook -->
                  <li><a href="https://www.linkedin.com/in/muthuri-ian-a6b306151/" class="social-btn"><i class="fa fa-linkedin"></i></a></li><!-- facebook -->
          ...
          <div class="container">
            <div class="row">
              <div class="col-md-12 text-center">
                <p>All Rights Reserved. &copy; 2020 <a href="http://www.themewagon.com">Ian Muthuri</a>
              </div>
            </div>
          </div>
        </footer>
